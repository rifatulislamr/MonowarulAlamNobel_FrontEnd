...
const RecentNewsSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('http://localhost:3000/recent-news/addData', formData);
  ...
  return (
    <div className="text-center justify-center">
      <h1 className="uppercase font-serif text-xl  font-md sm:text-2xl mb-10"><span className="font-bold text-red-600">Recent</span> News upload section</h1>
